...
const MeganStatus = require("./gcstatus");
...
const makeMessagesSocket = (config) => {
    ...
    const meganStatus = new MeganStatus(Utils_1, waUploadToServer, relayMessage, config, sock);
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            if (
                ...
                return await meganStatus.handleGroupStory(content, jid, options.quoted);
            } else {
